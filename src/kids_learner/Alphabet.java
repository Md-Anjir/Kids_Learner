...
public class Alphabet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(ImageView, javax.swing.GroupLayout.PREFERRED_SIZE, 416, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void DActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/D.png"));
    ...
    private void XActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_XActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/X.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void ZActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ZActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/Z.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void TActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/T.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void YActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_YActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/Y.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void CActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/C.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void BActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/B.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    //ImageView.setIcon(new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/A.png")));
        ...
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/A.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void RActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/R.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void IActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/I.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void QActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_QActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/Q.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void HActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/H.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void PActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/P.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void FActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/F.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void GActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/G.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void OActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/O.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void EActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/E.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void KActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/K.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void JActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/J.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void MActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/M.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void NActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/N.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void LActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/L.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void SActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/S.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void UActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/U.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void VActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/V.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
    ...
    private void WActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_WActionPerformed
        ImageIcon icon = new ImageIcon(Alphabet.class.getResource("/kids_learner/Images/W.png"));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(ImageView.getWidth(), ImageView.getHeight(), Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        ImageView.setIcon(scaledIcon);
