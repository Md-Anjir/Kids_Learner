 ...
 * @author ASUS
 */
public class P_subtraction extends javax.swing.JFrame {

    /**
     * Creates new form P_subtraction
     */
    public P_subtraction() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("practice [subtraction]");
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, 240, 70));
        ...
        jPanel1.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 280, 140, 70));
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        ...
        if(ans == ansT)
        {
            ...
            ProgressNumber.correct_no_sub++;
           
        }
        else
        {
            judge.setText("Sorry !! The answer is "+ans);
             ProgressNumber.wrong_no_sub++;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P_subtraction.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new P_subtraction().setVisible(true);
            }
        });
    }
